        ...
        <div class="row border-bottom">
          ...
          <div class="navbar-header">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-9">
                    <h2>Upload Nilai Kinerja</h2>
                    <ol class="breadcrumb">
                        <li>
                            <a href="<?php echo base_url()?>admin">Home</a>
                        </li>
                        <li class="active">
                            <strong>Upload Nilai Kinerja</strong>
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Upload Data <small>Berisi data nilai hasil kinerja pegawai.</small></h5>
                        </div>
                        <div class="ibox-content">
                        <?php echo form_open_multipart('admin/upload_kinerja')?>
                ...
                <tbody class="text-center">
                 <?php foreach($nilai_kinerja as $p) : ?>
                  <tr>
                  ...
                  <td style="width:15%"><?php echo $p->nilai?></td>
                </tr>
                    </div>
                  </div>
                </div>
