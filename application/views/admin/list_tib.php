...
<body>
    <div id="wrapper">
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                <div class="col-lg-3">
                    <button class="widget navy-bg" data-toggle="modal"  data-target="#daftar">
                        <div class="row">
                            <div class="col-xs-4">
                                <i class="fa fa-paper-plane fa-5x"></i>
                            </div>
                            <div class="col-xs-8 text-right">
                                <h2 class="font-bold" data-toggle="modal"  data-target="#daftara">Tambah Tim</h2>                       
                            </div>
                        </div>
                    </button>
                                                      ...
                                                      <div class="modal-dialog modal-lg" role="document">
                                                        <div class="modal-content">
                                                          ...
                                                          <div class="modal-body">
                                                                <!-- Isi Modal -->
                                                                <?php echo form_open_multipart('admin/tambah_tib')?>
                                                                <div class="row">
                                                                  <div class="col-md-3">
                                                                  ...
                                                                  <div class="col-md-3">
                                                                    <div class="form-group">
                                                                      <h5>Posisi</h5>
                                                                      <input type="text" name="posisi" class="form-control" autocomplete="off" required >
                                                                    </div>
                                                                  </div>
                                                                  <div class="col-md-3">
                                                                    <div class="form-group">
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Upload Data <small>Berisi data tim implementasi budaya  dari setiap unit.</small></h5>
                            <a href="<?php echo base_url()?>assets/tib.xlsx">Download Template Pengisian</a>
                        </div>
                        <div class="ibox-content">
                        <?php echo form_open_multipart('admin/upload_tib')?>
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Daftar Tim Implementasi Budaya</h5>
                ...
                <tbody class="text-center">
                  ...
                  <td style="width:12%"><?php echo $tib[$i]->unit?></td>
