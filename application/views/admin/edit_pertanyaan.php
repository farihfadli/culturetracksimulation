            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <?php echo form_open_multipart('admin/update/'.$target)?>
                            <strong><h3>Individu</h3></strong>
                            <div class="row">
                              <div class="col-md-2">
                                <div class="form-group">
                                  <h5>Direktorat</h5>
                                  <input type="text" class="form-control" disabled="true" name="nip1" autocomplete="off" placeholder="<?php echo $unit->direktorat;?>" value="<?php $unit->direktorat;?>">
                                </div>
                              </div>
                              <div class="col-md-2">
                                <div class="form-group">
                               ...
                               <div class="col-md-8">
                                <div class="form-group">
                                  <h5>Nama Unit/Area</h5>
                                  <input type="text" class="form-control" disabled="true" name="nama1" autocomplete="off" placeholder="<?php echo $unit->nama_pertanyaan;?>" value="<?php $unit->nama_pertanyaan;?>">
                                </div>
                              </div>                   
                            </div>
                            <div class="row">
              ...
              <div class="col-md-12">
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control " required name="q2" placeholder="Pertanyaan 2" value="<?=$q2; ?>">
                                    </div>
                            </div>
              <div class="col-md-12">
                                    <div class="form-group">
                                      <label>Pertanyaan 3</label>
                                      <input type="text" class="form-control " required name="q3" placeholder="Pertanyaan 3" value="<?=$q3; ?>">
                                    </div>
                            </div>
              <div class="col-md-12">
                                    <div class="form-group">
                                      <label>Pertanyaan 4</label>
                                      <input type="text" class="form-control " required name="q4" placeholder="Pertanyaan 4" value="<?=$q4; ?>">
                                    </div>
                            </div>
              <div class="col-md-12">
                                    <div class="form-group">
                                      <label>Pertanyaan 5</label>
                                      <input type="text" class="form-control " required name="q5" placeholder="Pertanyaan 5" value="<?=$q5; ?>">
                                    </div>
                            </div>
              <div class="col-md-12">
                                    <div class="form-group">
                                      <label>Pertanyaan 6</label>
                                      <input type="text" class="form-control " required name="q6" placeholder="Pertanyaan 6" value="<?=$q6; ?>">
                                    </div>
                            </div>
              <div class="col-md-12">
                                    <div class="form-group">
                                      <label>Pertanyaan 7</label>
                                      <input type="text" class="form-control " required name="q7" placeholder="Pertanyaan 7" value="<?=$q7; ?>">
                                    </div>
                            </div>
              <div class="col-md-12">
                                    <div class="form-group">
                                      <label>Pertanyaan 8</label>
                                      <input type="text" class="form-control " required name="q8" placeholder="Pertanyaan 8" value="<?=$q8; ?>">
                                    </div>
                            </div>
              <div class="col-md-12">
                                    <div class="form-group">
                                      <label>Pertanyaan 9</label>
                                      <input type="text" class="form-control " required name="q9" placeholder="Pertanyaan 9" value="<?=$q9; ?>">
                                    </div>
                            </div>
              <div class="col-md-12">
                                    <div class="form-group">
                                      <label>Pertanyaan 10</label>
                                      <input type="text" class="form-control " required name="q10" placeholder="Pertanyaan 10" value="<?=$q10; ?>">
                                    </div>
                            </div>
